<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TrophyGallery.aspx.vb" Inherits="WebApplication1.TrophyGallery" %>
...
.content-area{
  ...
  .panel::before{
    content:"";
    position:absolute;
    left:-10px;top:0;width:26px;height:100%;
...
.panel h1 {
  ...
  .panel p{
    margin-top:22px;color:#fff;font-size:22px;line-height:1.35;width:275px;font-weight:700;text-shadow:0 1px 0 rgba(0,0,0,0.6);
  }
  ...
  .score-box{
    ...
    left:694px; 
    bottom:70px;
    width:341px;height:80px;
    display:flex;align-items:center;
    font-size:32px;font-weight:800;color:white;
    box-sizing:border-box; word-spacing: 4px;
  }

  .header-text{
    position:absolute;left:220px;top:18px;font-family: 'Eurostile', Arial, sans-serif;
    font-size:56px;color:#dfeef9;font-weight:700;text-shadow:0 3px 0 rgba(0,0,0,0.8);
  }

  .left-tab{position:absolute;left:40px;top:150px;width:180px;height:54px;background:transparent}

  .trophy-replace{
    position:absolute;left:120px;top:160px;width:420px;height:420px;background:transparent;background-size:contain;background-repeat:no-repeat;background-position:center;
  }
...
<body>
  ...
  <div class="viewport" role="region" aria-label="melee-frame">
    ...
    <div class="frame-back" onclick="location.href='TrophyGalleryMenu.aspx'">
